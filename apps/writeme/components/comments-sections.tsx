  ...
  return (
    <Card className={fill ? "w-full" : ""}>
      ...
      <CardContent className="flex flex-col">
        {comments.length == 0 ? <><span className="grow text-center items-center mt-4" >Be the first to comment.</span></>: comments.map((c) => (
      ...
      <CardFooter className="flex justify-center items-center pt-6">
        ...
        </div> : <span className="grow text-center">Log In to Comment</span>}
      </CardFooter>
    </Card>
  );
}
