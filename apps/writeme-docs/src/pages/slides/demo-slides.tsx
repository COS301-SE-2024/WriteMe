...
import testExample from "./img/test_example.png"
import burnDown from './img/burn-down-chart.png'
import projectBoard from './img/project-board.png'
...
export default function DemoSlides(): JSX.Element {
    ...
    return (
      <Slides initSlides={defaultSlides}>
        <section
          data-background-image="/img/background-gradient.jpg">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="-20 0 193 60"
               style={{ transform: "scale(1)", border: "none" }} fill="none">
            <g clip-path="url(#a)">
        ...
        <section data-background-iframe="https://writeme.co.za/" data-background-interactive={false}>
          <div style={{ color: "white", padding: "5rem", background: "rgba(30, 31, 34, 25%)", borderRadius: "15px" }}>
            <h1>We are Deployed!</h1>
          </div>
        </section>
        ...
        < section
          ...
          <div className="fragment" style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
            ...
            <img
              style={{ objectFit: 'contain' }}
              src="https://img.shields.io/static/v1?style=for-the-badge&message=Playwright&color=2EAD33&logo=Playwright&logoColor=FFFFFF&label="
              alt={'playwright'} />
          </div>
          <div className="fragment" style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
            <p>
            ...
            <img
              style={{ objectFit: 'contain' }}
              src="https://camo.githubusercontent."
              alt={'vitest'} />
          </div>
          <div className="fragment" style={{ display: 'flex', justifyContent: "center", gap: "1rem" }}>
            <p>Story Book for Visual Testing</p>
            <img
              style={{ objectFit: 'contain' }}
          ...
          <img className="fragment" src={testExample} alt={'test example'} />
        </section>
          <section data-background-iframe="https://storybook.writeme.co.za/?path=/story/stories-button--default&args=variant:secondary&globals=theme:light"></section>
        <section data-background-image="/img/background-gradient.jpg">
          <h2>CI/CD</h2>
        </section>
        <section data-background-image="/img/background-gradient.jpg">
